...
@Component({
  selector: 'ngx-dashboard00',
  styleUrls: ['./dashboard00.component.scss'],
  templateUrl: './dashboard00.component.html',
})
export class DashboardComponent00 implements OnDestroy {
